			...
			<div className="container mx-auto bg-purple-700 flex flex-col sm:flex-row items-center sm:pl-12 justify-between bg-mobile-app rounded-lg">
				<div className="text-white p-5 sm:p-0 text-center sm:text-left">
					...
					<div className="grid sm:flex grid-cols-2 gap-2 mt-4 sm:mt-8">
						<a href="/#">
							<img
								src="https://getir.com/_next/static/images/appstore-tr-141ed939fceebdcee96af608fa293b31.svg" alt="getir"/>
						</a>
						<a href="/#">
							<img
								src="https://getir.com/_next/static/images/googleplay-tr-6b0c941b7d1a65d781fb4b644498be75.svg" alt="getir"/>
						</a>
						<a href="/#">
							<img
								src="https://getir.com/_next/static/images/huawei-appgallery-tr-4b890fa3167bc62f9069edaf45aa7f30.svg" alt="getir"/>
						</a>
					</div>
				</div>
